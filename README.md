...
> **Note:** This is a modified version of [CommandBlockerPro](https://github.com/JadedMC/CommandBlockerPro) by JadedMC, distributed under the MIT License. Modifications by YoannFM (added the `{command}` placeholder support in block messages).
